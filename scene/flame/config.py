...
class FlameConfig:
    def __init__(self):
        self.flame_model_path = 'scene/flame/model/flame2023.pkl'
        self.static_landmark_embedding_path = 'scene/flame/model/flame_static_embedding.pkl'
        self.dynamic_landmark_embedding_path = 'scene/flame/model/flame_dynamic_embedding.npy'
